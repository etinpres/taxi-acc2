...
import { getCurrentMonth, getPrevMonth } from '@/lib/date-utils';
  ...
  return (
    <div className="space-y-4 pt-2">
      <div className="flex items-center justify-between px-4 pt-2">
        <h1 className="text-lg font-bold">월별 통계</h1>
        <div className="flex bg-gray-100 rounded-lg p-0.5">
          <button
            onClick={() => setView('stats')}
            className={`flex items-center gap-1 px-3 py-1.5 rounded-md text-xs font-medium transition-colors ${
              view === 'stats' ? 'bg-white text-gray-900 shadow-sm' : 'text-gray-500'
            }`}
          >
            <BarChart3 size={14} />
            통계
        ...
        <>
          ...
          <div className="bg-white rounded-xl mx-4 p-4 shadow-sm">
            <div className="flex items-center justify-between mb-3">
              <h2 className="text-sm font-semibold text-gray-700">근무 현황</h2>
            </div>
